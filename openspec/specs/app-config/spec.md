...
Validate and load HoundFe chatbot configuration at boot. All required environment
variables MUST be present and well-formed before the application starts accepting
traffic; missing or malformed values MUST cause boot to fail loudly so misconfigured
deployments never serve webhook traffic.
